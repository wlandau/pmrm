# Fitted values: non-proportional slowing model.

Compute the fitted values of a fitted non-proportional slowing model.
...
``` r
  ...
  str(fitted(fit))
#>  num [1:1500] -1.023 1.68 -2.245 0.731 -0.757 ...
```
