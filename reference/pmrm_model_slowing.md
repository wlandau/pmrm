...
``` r
  ...
  str(fit$estimates)
#> List of 9
#>  $ alpha : Named num [1:5] 0.00274 0.80652 0.89579 1.38831 1.65613
#>   ..- attr(*, "names")= chr [1:5] "1" "2" "3" "4" ...
#>  $ theta : num [1:2, 1:4] 0.507 0.578 -0.109 0.167 0.151 ...
#>  $ gamma : num [1:2] 1.01 1.96
#>  $ phi   : num [1:5] 0.00709 -0.0325 0.01659 -0.02732 0.00772
#>  $ rho   : num [1:10] -0.00339 -0.06394 0.02979 -0.10189 -0.07405 ...
